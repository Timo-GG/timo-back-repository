...
-- 4. Post 테이블
-------------------------------------------------
INSERT INTO post (title, content, member_id, view_count, like_count, category, mod_date, reg_date)
VALUES
    ('테스트 제목: 1', '테스트 내용...1', 1, 50, 0, 'NORMAL', now(), now()),
    ('테스트 제목: 2', '테스트 내용...2', 2, 100, 0, 'NORMAL', now(), now()),
    ('테스트 제목: 3', '테스트 내용...3', 3, 150, 0, 'NORMAL', now(), now());
