...
public class MatchInfoDTO {
        ...
        // UserInfo.UserInfoBuilder.class)
        @Getter
        @ToString
        @Jacksonized
        public static class UserInfo {
                ...
                public UserInfo(
                        ...
                        if (pentaKills > 0)
                                this.multiKill = "펜타킬";
                        else if (quadraKillB > 0)
                                this.multiKill = "쿼드라킬";
                        else if (tripleKillB > 0)
                                this.multiKill = "트리플킬";
                        else if (doubleKillB > 0)
                                this.multiKill = "더블킬";
                        else
                                this.multiKill = null;
        ...
        public static MatchInfoDTO of(String json) {
                ...
                List<UserInfo> userInfos = node.read(
                                "$.info.participants.*['puuid',  'riotIdGameName', 'riotIdTagline', 'championName'," +
